...
//! (`lot_size`), минимальный объём (`min_qty`). Активы `base`/`quote` используются Ledger'ом
//! при расчёте сделок. Реестр — конфиг-состояние: инструмент регистрируется до торгов.
