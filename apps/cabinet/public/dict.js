...
(function () {
  const DICT = {
    en: {
      ...
      'ov.fundNote': 'Demo environment — funds are virtual (paper money).',
      'ov.deposit': 'Deposit', 'ov.withdraw': 'Withdraw', 'ov.amount': 'Amount, $',
      'fund.ok': 'Done.', 'fund.bad': 'Enter a valid amount.',
      'fund.insufficient': 'Not enough free funds to withdraw.',
      'fund.err': 'Something went wrong. Try again.',
    ...
    ru: {
      ...
      'ov.fundNote': 'Демо-среда — деньги виртуальные (бумажные).',
      'ov.deposit': 'Пополнить', 'ov.withdraw': 'Вывести', 'ov.amount': 'Сумма, $',
      'fund.ok': 'Готово.', 'fund.bad': 'Введите корректную сумму.',
      'fund.insufficient': 'Недостаточно свободных средств для вывода.',
      'fund.err': 'Что-то пошло не так. Попробуйте ещё раз.',
