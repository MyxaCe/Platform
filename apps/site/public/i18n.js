...
(function () {
  ...
  const DICT = {
    en: {
      ...
      'auth.ok.register': 'Account created. Welcome aboard!',
      'auth.ok.login': 'Signed in.',
      'auth.err.taken': 'This email is already registered',
      'auth.err.creds': 'Invalid email or password',
      'auth.err.rate': 'Too many attempts. Please try again later.',
      'auth.err.net': 'Server is unavailable. Please try again.',
      'cta.logout': 'Log out',
    ...
    ru: {
      ...
      'auth.ok.register': 'Аккаунт создан. Добро пожаловать!',
      'auth.ok.login': 'Вы вошли.',
      'auth.err.taken': 'Эта почта уже зарегистрирована',
      'auth.err.creds': 'Неверная почта или пароль',
      'auth.err.rate': 'Слишком много попыток. Попробуйте позже.',
      'auth.err.net': 'Сервер недоступен. Попробуйте ещё раз.',
      'cta.logout': 'Выход',
