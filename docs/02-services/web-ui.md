...
- Данные **реальные с Binance** (ADR-013), но **исполнение сделок пока не работает** — BUY/SELL
  показывают намерение по реальной цене; фактическое исполнение — broker-режим (позиции/маржа/P&L),
  следующий этап. [[backlog]]
- Метрики MARGIN/CREDIT/OPEN P&L — заглушки `$0` (нет позиций/маржи). [[backlog]]
